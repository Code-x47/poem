...
<div class="music-section">
      ...
      @if($sermon->month == 1 && $sermon->year == 2025)
    <h2>{{ \Carbon\Carbon::createFromDate(null, $sermon['month'], 1)->format('F') }} {{$sermon['year']}}</h2>
     @break
     @endif
     @endforeach
    <div class="grid">
      ...
      <div class="song-card">
        ...
        <audio id='song-ctrl7' controls src="{{ asset('sermons/' . $sermon->audio_path) }}"></audio>
        <div class="song-buttons" style="display: flex; gap: 0.5rem;">
         
         <button onclick="document.getElementById('song-ctrl7').play()">▶ Play</button>
...
<div class="music-section">
      @foreach($sermons AS $sermon)
      @if($sermon->month == 2 && $sermon->year == 2025)
    <h2>{{ \Carbon\Carbon::createFromDate(null, $sermon['month'], 1)->format('F') }} {{$sermon['year']}}</h2>
     @break
     @endif
     @endforeach
...
<div class="music-section">
      @foreach($sermons AS $sermon)
      @if($sermon->month == 3 && $sermon->year == 2025)
    <h2>{{ \Carbon\Carbon::createFromDate(null, $sermon['month'], 1)->format('F') }} {{$sermon['year']}}</h2>
     @break
     @endif
     @endforeach
...
<!--End-->
 ...
 <div class="music-section">
      @foreach($sermons AS $sermon)
      @if($sermon->month == 4 && $sermon->year == 2025)
    <h2>{{ \Carbon\Carbon::createFromDate(null, $sermon['month'], 1)->format('F') }} {{$sermon['year']}}</h2>
     @break
     @endif
     @endforeach
...
<!--End-->
  ...
  <div class="music-section">
      @foreach($sermons AS $sermon)
      @if($sermon->month == 5 && $sermon->year == 2025)
    <h2>{{ \Carbon\Carbon::createFromDate(null, $sermon['month'], 1)->format('F') }} {{$sermon['year']}}</h2>
     @break
     @endif
     @endforeach
...
<!--End-->
 <div class="music-section">
      @foreach($sermons AS $sermon)
      @if($sermon->month == 6 && $sermon->year == 2025)
    <h2>{{ \Carbon\Carbon::createFromDate(null, $sermon['month'], 1)->format('F') }} {{$sermon['year']}}</h2>
     @break
     @endif
     @endforeach
    <div class="grid">
      ...
      <div class="song-card">
        <div class="song-title">{{$sermon['title']}}</div>
        <div class="song-artist">{{$sermon['minister']}}</div>
        <audio id='song-ctrl6' controls src="{{ asset('sermons/' . $sermon->audio_path) }}"></audio>
        <div class="song-buttons" style="display: flex; gap: 0.5rem;">
         
         <button onclick="document.getElementById('song-ctrl6').play()">▶ Play</button>
    ...
    <div class="music-section">
      @foreach($sermons AS $sermon)
      @if($sermon->month == 7 && $sermon->year == 2025)
    <h2>{{ \Carbon\Carbon::createFromDate(null, $sermon['month'], 1)->format('F') }} {{$sermon['year']}}</h2>
     @break
     @endif
     @endforeach
  ...
  <div class="music-section">
      @foreach($sermons AS $sermon)
      @if($sermon->month == 8 && $sermon->year == 2025)
    <h2>{{ \Carbon\Carbon::createFromDate(null, $sermon['month'], 1)->format('F') }} {{$sermon['year']}}</h2>
     @break
     @endif
     @endforeach
...
<div class="music-section">
      @foreach($sermons AS $sermon)
      @if($sermon->month == 9 && $sermon->year == 2025)
    <h2>{{ \Carbon\Carbon::createFromDate(null, $sermon['month'], 1)->format('F') }} {{$sermon['year']}}</h2>
     @break
     @endif
     @endforeach
...
<div class="music-section">
      @foreach($sermons AS $sermon)
      @if($sermon->month == 10 && $sermon->year == 2025)
    <h2>{{ \Carbon\Carbon::createFromDate(null, $sermon['month'], 1)->format('F') }} {{$sermon['year']}}</h2>
     @break
     @endif
     @endforeach
...
<div class="music-section">
      @foreach($sermons AS $sermon)
      @if($sermon->month == 11 && $sermon->year == 2025)
    <h2>{{ \Carbon\Carbon::createFromDate(null, $sermon['month'], 1)->format('F') }} {{$sermon['year']}}</h2>
     @break
     @endif
     @endforeach
...
<div class="music-section">
      @foreach($sermons AS $sermon)
      @if($sermon->month == 12 && $sermon->year == 2025)
    <h2>{{ \Carbon\Carbon::createFromDate(null, $sermon['month'], 1)->format('F') }} {{$sermon['year']}}</h2>
     @break
     @endif
     @endforeach
